...
public class MatUserMainDisplay extends BaseGoogleActivity {
        ...
        private void init_user(){
            ...
            LOCATION = user.location = getLocality();
            if(LOCATION == null) {
                settings = getSharedPreferences(SharedPrefKeys.LOGIN_SETTINGS, 0);
                LOCATION = settings.getString(SharedPrefKeys.LOC_KEY, null);
            }
        ...
        private void init_ui(){
            ...
            mAdapter = new ProfileRecycleAdapter(TITLES,ICONS,NAME,EMAIL, PICTURE, LOCATION,
