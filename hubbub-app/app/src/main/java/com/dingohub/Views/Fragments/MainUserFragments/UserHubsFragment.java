...
import com.dingohub.Views.Activities.DevActivities.CreateHubActivity;
...
public class UserHubsFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_user_hubs, container,
                false);
    ...
    private void init_fab(View rootView){
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), CreateHubActivity.class);
                startActivity(i);
            }
        });
    }
        ...
        public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
            ...
            if(child!=null && mGestureDetector.onTouchEvent(e)){
                ...
                if(followed_hubs.size() != 0) {
                    ...
                    intent.putExtra(ViewHubActivity.HUB_KEY, eventId);                    // MAKE Bub parcelable
